export default {
    translation: {
      ...
      minimumFromStatement: 'From your statement · tap to edit',
      minimumEstimated: 'Estimated · tap to enter actual',
      minimumPaymentFromStatement: 'Minimum payment (from statement)',
