export default {
    translation: {
      ...
      minimumFromStatement: 'De tu estado de cuenta · toca para editar',
      minimumEstimated: 'Estimado · toca para ingresar el real',
      minimumPaymentFromStatement: 'Pago mínimo (del estado de cuenta)',
